...
type Nav = StackNavigationProp<RootStackParamList, 'Act7RateActivity'>;
...
const Act7RateActivityPage: React.FC = () => {
        ...
        try {
            ...
            if (user) {
                try {
                    ...
                    console.error('[Act7RateActivity] Failed to update team points:', err);
                }
            }
            ...
            console.error('[Act7RateActivity] Error saving rating:', error);
        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            <View style={styles.container}>
                ...
                >
                    ...
                    {/* Jupiter planet — bottom of screen */}
                    <Image
...
export default Act7RateActivityPage;