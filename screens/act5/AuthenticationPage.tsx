...
type Nav = StackNavigationProp<RootStackParamList, 'Act5Authentication'>;
...
const AuthenticationPage: React.FC = () => {
    ...
    const handleStart = () => {
        navigation.navigate('Act5Equipment');
    };
    ...
    return (
        <View style={styles.container}>
            ...
            >
                ...
                <Image
                    source={require('../../assets/AuthenticationAssets/bigSaturn.png')}
