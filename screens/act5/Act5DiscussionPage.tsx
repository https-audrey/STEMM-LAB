...
type Nav = StackNavigationProp<RootStackParamList, 'Act5Discussion'>;
...
const Act5DiscussionPage: React.FC = () => {
    ...
    const handleContinue = () => {
        navigation.navigate('Act5Curriculum');
    };
        ...
        <View style={styles.container}>
            ...
            >
                ...
                <View style={styles.boxContainer}>
                    <Image
                        source={require('../../assets/DiscussionAssets/act5discussionBox.png')}
...
export default Act5DiscussionPage;
