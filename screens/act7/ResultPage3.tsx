...
type Nav = StackNavigationProp<RootStackParamList, 'Act7Result3'>;
...
const Act7ResultPage3: React.FC = () => {
    ...
    const fetchRecordings = async () => {
        ...
        try {
            ...
            console.error('[Act7Result3] Error:', error);
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleAddRecording = () => {
        // Navigate back to ExperimentPage3 (placeholder)
        // navigation.navigate('Act7Experiment3');
        navigation.goBack();
    };
        ...
        <View style={styles.container}>
            <ImageBackground source={require('../../assets/OnBoardingAssets/bgImg.png')} style={styles.background} resizeMode="cover">
                ...
                <View style={styles.boxContainer}>
                    <Image source={require('../../assets/RecordingResultAssets/act7ResultBox3.png')} style={styles.resultBox} resizeMode="contain" />
...
export default Act7ResultPage3;
