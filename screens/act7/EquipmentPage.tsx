...
type Nav = StackNavigationProp<RootStackParamList, 'Act7Equipment'>;
...
const Act7EquipmentPage: React.FC = () => {
    ...
    const handleContinue = () => {
        navigation.navigate('Act7Instruction');
    };
        ...
        <View style={styles.container}>
            ...
            >
                ...
                <View style={styles.boxContainer}>
                    <Image
                        source={require('../../assets/EquipmentAssets/act7EquipmentBox.png')}
...
export default Act7EquipmentPage;