...
type Nav = StackNavigationProp<RootStackParamList, 'Act7Result1'>;
...
const Act7ResultPage1: React.FC = () => {
    ...
    const fetchRecordings = async () => {
        ...
        try {
            ...
            console.error('[Act7Result1] Error fetching recordings:', error);
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleAddRecording = () => {
        // Navigate back to ExperimentPage1 to add another recording
    ...
    const handleSaveName = async () => {
        ...
        try {
            ...
            console.error('[Act7Result1] Firestore update failed:', error);
        ...
        <View style={styles.container}>
            ...
            >
                ...
                <View style={styles.boxContainer}>
                    ...
                    {/* Scrollable listing box of recording files */}
...
export default Act7ResultPage1;
